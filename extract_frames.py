...
def main():
    ...
    # Clampping depth to 16-bit unsigned integer range, since the ZED SDK returns
    # depth in millimeters, and the maximum representable value in 16-bit unsigned
    # integer is 65535. Depth values beyond this range will be clamped to 65535.
    DEPTH_MAX_MM = 65535

    # The ZED SDK's confidence measure is documented as an integer-like
    # scale from 1 to 100, 1 being most relliable and 100 being least reliable.
